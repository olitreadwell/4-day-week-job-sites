# 4-Day-Week Job Sites

[![Entries](https://img.shields.io/github/directory-file-count/olitreadwell/4-day-week-job-sites/data/entries?type=file&extension=yaml&label=entries&color=brightgreen)](GUIDE.md)
[![CI](https://github.com/olitreadwell/4-day-week-job-sites/actions/workflows/ci.yml/badge.svg)](https://github.com/olitreadwell/4-day-week-job-sites/actions/workflows/ci.yml)
[![Link check](https://github.com/olitreadwell/4-day-week-job-sites/actions/workflows/linkcheck.yml/badge.svg)](https://github.com/olitreadwell/4-day-week-job-sites/actions/workflows/linkcheck.yml)
[![License: MIT](https://img.shields.io/badge/license-MIT-blue.svg)](LICENSE)

A living, link-checked directory of job sites focused on four-day work weeks.

## What this is

A living, link-checked directory of job sites for four-day work weeks. Every entry is a small YAML
...
- **5 live**: reachable and returning 2xx/3xx
